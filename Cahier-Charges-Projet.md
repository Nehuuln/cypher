...
- [x] **Toutes les requêtes SQL utilisent des requêtes préparées**
...
- [x] **Une fonctionnalité permettant aux utilisateurs de poster du texte** (commentaire, bio, titre, etc.)
